...
> If your UX asks the user to make _choices_, for example, even if those choices are both clear and useful, the act of _deciding_ is a cognitive drain. And not just _while_ they’re deciding... even _after_ we choose, an unconscious cognitive background thread is slowly consuming/leaking resources, “Was _that_ the right choice?”
